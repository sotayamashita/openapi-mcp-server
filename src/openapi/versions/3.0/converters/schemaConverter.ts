 ...
 */
function convertStringSchema(schema: OpenAPIV3.SchemaObject): ZodTypeAny {
 ...
 */
function convertNumberSchema(schema: OpenAPIV3.SchemaObject): ZodTypeAny {
 ...
 */
function convertArraySchema(schema: OpenAPIV3.SchemaObject): ZodTypeAny {
  if (!schema.items) return z.array(z.any());

  return z.array(
    convertOpenAPISchemaToZod(schema.items as OpenAPIV3.SchemaObject),
  );
}
 ...
 */
function convertObjectSchema(schema: OpenAPIV3.SchemaObject): ZodTypeAny {
